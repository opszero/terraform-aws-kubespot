...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&config.AwsSecretId, "aws-secret-id", "", "Use AWS Secrets Manager for Config. If set it pull the environment variables from aws secrets manager.")

data "aws_ssm_parameter" "amis" {
  for_each = {
    ...
    "AL2023_x86_64_NEURON"       = "/aws/service/eks/optimized-ami/${var.cluster_version}/amazon-linux-2023/x86_64/standard2/recommended/image_id",
    "AL2023_x86_64_NVIDIA"       = "/aws/service/eks/optimized-ami/${var.cluster_version}/amazon-linux-2023/x86_64/standard2/recommended/image_id"
  }

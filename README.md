...
| <a name="provider_aws.virginia"></a> [aws.virginia](#provider\_aws.virginia) | ~> 4.17.0 |
...
| <a name="input_karpenter_version"></a> [karpenter\_version](#input\_karpenter\_version) | The version of the karpenter helm chart | `string` | `"v0.22.1"` | no |
